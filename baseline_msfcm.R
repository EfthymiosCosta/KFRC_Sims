...
OUT_DIR <- "sim_bw_selection/baseline_msfcm_res"
LOG_DIR <- "sim_bw_selection/baseline_msfcm_logs"
...
agg_msfcm <- aggregate_baseline()
saveRDS(agg_msfcm, "baseline_msfcm.rds")
cat(sprintf("Saved %d rows to baseline_msfcm.rds\n", nrow(agg_msfcm)))
